...
const CarouselMovieTopRated = () => {
 
 
  const {data}=useFetch(getTopRatedMovies);
  ...
  return (
    ...
    <>
    <CarouselContainer>
    <h4 style={{padding:"1rem"}}>Peliculas mejores rankeadas</h4>
    <Swiper
    slidesPerView={8}
    spaceBetween={1}
    slidesPerGroup={4}
...
export default CarouselMovieTopRated